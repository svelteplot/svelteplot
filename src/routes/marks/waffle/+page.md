...
You can pass the **symbol** snippet to customize the shape of the waffle cells (but remember to [choose your icon wisely](https://www.vis4.net/blog/choose-your-icons-wisely/)). The snippet is provided with the following variables: `{ x, y, width, height, datum }`.
...
- **symbol** - A snippet you can use to customize the shape of each waffle cell. The symbol snippet is provided with the following variables `{ x, y, width, height, datum }`.
