<script module lang="ts">
    export const title = 'Walmart store openings';
    export const description =
        'A state basemap with Walmart store locations. Data by <a href="https://users.econ.umn.edu/~holmes/data/WalMart/index.html">Thomas J. Holmes</a>.';
    export const sortKey = 70;
    export const data = {
...
<script lang="ts">
    ...
    const startDate =
        sortedWalmart[0]?.opendate ?? new Date(1962, 0, 1);
    const endDate =
        sortedWalmart[sortedWalmart.length - 1]?.opendate ??
        new Date(2020, 0, 1);
