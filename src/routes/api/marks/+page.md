...
| `mixBlendMode`     | ConstantAccessor&lt;CSS.Property.MixBlendMode, T&gt;                                                                                                            | the CSS mix-blend-mode for compositing (e.g. "multiply", "screen")                                                                       |
...
| `onclick`          | MouseEventHandler&lt;SVGPathElement&gt;                                                                                                                         | fired when the mark element is clicked                                                                                                   |
| `ondblclick`       | MouseEventHandler&lt;SVGPathElement&gt;                                                                                                                         | fired when the mark element is double-clicked                                                                                            |
| `onmouseup`        | MouseEventHandler&lt;SVGPathElement&gt;                                                                                                                         | fired when a mouse button is released over the mark                                                                                      |
| `onmousedown`      | MouseEventHandler&lt;SVGPathElement&gt;                                                                                                                         | fired when a mouse button is pressed over the mark                                                                                       |
| `onmouseenter`     | MouseEventHandler&lt;SVGPathElement&gt;                                                                                                                         | fired when the pointer enters the mark element                                                                                           |
| `onmousemove`      | MouseEventHandler&lt;SVGPathElement&gt;                                                                                                                         | fired when the pointer moves within the mark element                                                                                     |
| `onmouseleave`     | MouseEventHandler&lt;SVGPathElement&gt;                                                                                                                         | fired when the pointer leaves the mark element                                                                                           |
| `onmouseout`       | MouseEventHandler&lt;SVGPathElement&gt;                                                                                                                         | fired when the pointer moves out of the mark element                                                                                     |
| `onmouseover`      | MouseEventHandler&lt;SVGPathElement&gt;                                                                                                                         | fired when the pointer moves onto the mark element                                                                                       |
| `onpointercancel`  | MouseEventHandler&lt;SVGPathElement&gt;                                                                                                                         | fired when a pointer event is canceled                                                                                                   |
| `onpointerdown`    | MouseEventHandler&lt;SVGPathElement&gt;                                                                                                                         | fired when a pointer becomes active over the mark                                                                                        |
| `onpointerup`      | MouseEventHandler&lt;SVGPathElement&gt;                                                                                                                         | fired when a pointer is released over the mark                                                                                           |
| `onpointerenter`   | MouseEventHandler&lt;SVGPathElement&gt;                                                                                                                         | fired when a pointer enters the mark element                                                                                             |
| `onpointerleave`   | MouseEventHandler&lt;SVGPathElement&gt;                                                                                                                         | fired when a pointer leaves the mark element                                                                                             |
| `onpointermove`    | MouseEventHandler&lt;SVGPathElement&gt;                                                                                                                         | fired when a pointer moves within the mark element                                                                                       |
| `onpointerover`    | MouseEventHandler&lt;SVGPathElement&gt;                                                                                                                         | fired when a pointer moves onto the mark element                                                                                         |
| `onpointerout`     | MouseEventHandler&lt;SVGPathElement&gt;                                                                                                                         | fired when a pointer moves out of the mark element                                                                                       |
| `ondrag`           | MouseEventHandler&lt;SVGPathElement&gt;                                                                                                                         | fired continuously while the mark is being dragged                                                                                       |
| `ondrop`           | MouseEventHandler&lt;SVGPathElement&gt;                                                                                                                         | fired when a dragged element is dropped on the mark                                                                                      |
| `ondragstart`      | MouseEventHandler&lt;SVGPathElement&gt;                                                                                                                         | fired when a drag operation begins on the mark                                                                                           |
| `ondragenter`      | MouseEventHandler&lt;SVGPathElement&gt;                                                                                                                         | fired when a dragged element enters the mark                                                                                             |
| `ondragleave`      | MouseEventHandler&lt;SVGPathElement&gt;                                                                                                                         | fired when a dragged element leaves the mark                                                                                             |
| `ondragover`       | MouseEventHandler&lt;SVGPathElement&gt;                                                                                                                         | fired when a dragged element is over the mark                                                                                            |
| `ondragend`        | MouseEventHandler&lt;SVGPathElement&gt;                                                                                                                         | fired when a drag operation ends                                                                                                         |
| `ontouchstart`     | MouseEventHandler&lt;SVGPathElement&gt;                                                                                                                         | fired when a touch point is placed on the mark                                                                                           |
| `ontouchmove`      | MouseEventHandler&lt;SVGPathElement&gt;                                                                                                                         | fired when a touch point moves along the mark                                                                                            |
| `ontouchend`       | MouseEventHandler&lt;SVGPathElement&gt;                                                                                                                         | fired when a touch point is removed from the mark                                                                                        |
| `ontouchcancel`    | MouseEventHandler&lt;SVGPathElement&gt;                                                                                                                         | fired when a touch event is canceled                                                                                                     |
| `oncontextmenu`    | MouseEventHandler&lt;SVGPathElement&gt;                                                                                                                         | fired when the context menu is triggered on the mark                                                                                     |
| `onwheel`          | MouseEventHandler&lt;SVGPathElement&gt;                                                                                                                         | fired when the mouse wheel is scrolled over the mark                                                                                     |
